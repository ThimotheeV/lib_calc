    ...
    SECTION("phi 2 diploid pop without missing value")
    {
        ...
        for (int indiv = 0; indiv < data_plane_vec.nbr_of_indiv_per_deme(0); ++indiv)
        {
            ...
            for (int indiv_other_deme = 0; indiv_other_deme < data_plane_vec.nbr_of_indiv_per_deme(1); ++indiv_other_deme)
            {
                ...
                int locus_j_indiv2_gene1 = data_plane_vec(1, 0, 1, indiv_other_deme, 0);
                int locus_j_indiv2_gene2 = data_plane_vec(1, 0, 1, indiv_other_deme, 1);
        ...
        for (int indiv = 0; indiv < data_plane_vec.nbr_of_indiv_per_deme(0); ++indiv)
        {
            ...
            for (int indiv_other_deme = 0; indiv_other_deme < data_plane_vec.nbr_of_indiv_per_deme(1); ++indiv_other_deme)
            {
                ...
                int locus_j_indiv2_gene1 = data_plane_vec(2, 0, 1, indiv_other_deme, 0);
                int locus_j_indiv2_gene2 = data_plane_vec(2, 0, 1, indiv_other_deme, 1);
