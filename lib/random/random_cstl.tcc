...
namespace cstl
{
  ...
  template <typename _UIntType, size_t __w,
            ...
            _UIntType __b, size_t __t, _UIntType __c, size_t __l,
            _UIntType __f>
  typename mersenne_twister_engine<_UIntType, __w, __n, __m, __r, __a, __u, __d,
  ...
  {
    cstl::linear_congruential_engine<result_type, 40014u, 0u, 2147483563u>
    ...
    for (size_t __i = 0; __i < long_lag; ++__i)
    {
      ...
      for (size_t __j = 0; __j < __n; ++__j)
      {
        __sum += __detail::__mod<uint_least32_t,
                                 __detail::_Shift<uint_least32_t, 32>::__value>(__lcg()) *
                 __factor;
        __factor *= __detail::_Shift<_UIntType, 32>::__value;
      }
      _M_x[__i] = __detail::__mod<_UIntType,
      ...
      operator()()
  {
    ...
    const _Eresult_type __r = (_M_b.max() - _M_b.min() < std::numeric_limits<_Eresult_type>::max()
                                   ? _M_b.max() - _M_b.min() + 1
                                   : 0);
    const unsigned __edig = std::numeric_limits<_Eresult_type>::digits;
    const unsigned __m = __r ? cstl::__lg(__r) : __edig;
  ...
  operator()(_UniformRandomNumberGenerator &__urng)
  {
    ...
    cstl::poisson_distribution<result_type> __poisson(__y);
  ...
  operator()(_UniformRandomNumberGenerator &__urng,
             const param_type &__p)
  {
    typedef typename cstl::gamma_distribution<double>::param_type
        param_type;
  ...
  template <typename _ForwardIterator,
            typename _UniformRandomNumberGenerator>
  void
  cstl::exponential_distribution<_RealType>::
      __generate_impl(_ForwardIterator __f, _ForwardIterator __t,
                      _UniformRandomNumberGenerator &__urng,
                      const param_type &__p)
  {
  ...
  template <typename _ForwardIterator,
            typename _UniformRandomNumberGenerator>
  void
  cstl::chi_squared_distribution<_RealType>::
      __generate_impl(_ForwardIterator __f, _ForwardIterator __t,
                      _UniformRandomNumberGenerator &__urng)
  { 
    while (__f != __t)
  ...
  template <typename _ForwardIterator,
            typename _UniformRandomNumberGenerator>
  void
  cstl::fisher_f_distribution<_RealType>::
      __generate_impl(_ForwardIterator __f, _ForwardIterator __t,
                      _UniformRandomNumberGenerator &__urng)
  { 
    while (__f != __t)
  ...
  template <typename _ForwardIterator,
            typename _UniformRandomNumberGenerator>
  void
  cstl::student_t_distribution<_RealType>::
      __generate_impl(_ForwardIterator __f, _ForwardIterator __t,
                      _UniformRandomNumberGenerator &__urng)
  {
    while (__f != __t)
  ...
  generate_canonical(_UniformRandomNumberGenerator &__urng)
  {
    ...
    const size_t __b = std::min(static_cast<size_t>(std::numeric_limits<_RealType>::digits),
                                __bits);
    ...
    {
      __ret = _RealType(1) - std::numeric_limits<_RealType>::epsilon() / _RealType(2);
    }
    return __ret;
  }
} // namespace cstl
